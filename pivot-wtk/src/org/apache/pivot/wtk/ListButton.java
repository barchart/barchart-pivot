...
public class ListButton extends Button {
	private static class ListButtonListenerList extends
			WTKListenerList<ListButtonListener> implements ListButtonListener {
		@Override
		...
		public void disabledItemFilterChanged(ListButton listButton,
			...
			for (ListButtonListener listener : this) {
				listener.disabledItemFilterChanged(listButton,
	...
	private static class ListButtonItemListenerList extends
			WTKListenerList<ListButtonItemListener> implements
	...
	private static class ListButtonSelectionListenerList extends
			WTKListenerList<ListButtonSelectionListener> implements
	...
	private static class ListButtonBindingListenerList extends
			WTKListenerList<ListButtonBindingListener> implements
			ListButtonBindingListener {
		@Override
		public void listDataKeyChanged(ListButton listButton,
		...
		@Override
		public void listDataBindTypeChanged(ListButton listButton,
				BindType previousListDataBindType) {
			for (ListButtonBindingListener listener : this) {
				listener.listDataBindTypeChanged(listButton,
		...
		public void listDataBindMappingChanged(ListButton listButton,
			...
			for (ListButtonBindingListener listener : this) {
				listener.listDataBindMappingChanged(listButton,
						previousListDataBindMapping);
			}
		}

		@Override
		public void selectedItemKeyChanged(ListButton listButton,
				String previousSelectedItemKey) {
			for (ListButtonBindingListener listener : this) {
				listener.selectedItemKeyChanged(listButton,
		...
		public void selectedItemBindTypeChanged(ListButton listButton,
			...
			for (ListButtonBindingListener listener : this) {
				listener.selectedItemBindTypeChanged(listButton,
		...
		public void selectedItemBindMappingChanged(ListButton listButton,
			...
			for (ListButtonBindingListener listener : this) {
				listener.selectedItemBindMappingChanged(listButton,
	...
	private ListListener<Object> listDataListener = new ListListener<Object>() {
		...
		public void itemInserted(List<Object> list, int index) {
			...
			if (selectedIndex != previousSelectedIndex) {
				listButtonSelectionListeners.selectedIndexChanged(
		...
		public void listCleared(List<Object> list) {
			...
			if (previousSelectedIndex != selectedIndex) {
				listButtonSelectionListeners.selectedIndexChanged(
						ListButton.this, selectedIndex);
				listButtonSelectionListeners.selectedItemChanged(
						ListButton.this, getSelectedItem());
			}
		}
	 ...
	 * <p>
	 * Note that the default renderer uses (as last option) the toString method
	 * on list elements, so override it to return whatever you want to display
	 * in the ListView, or implement your own custom renderer.
	 * 
	 * @param buttonData
	 *            The button data.
	 * 
	...
	public void setToggleButton(boolean toggleButton) {
		throw new UnsupportedOperationException(
				"List buttons cannot be toggle buttons.");
	}
	...
	public void setListData(List<?> listData) {
		...
		if (previousListData != listData) {
			...
			if (previousListData != null) {
				...
				((List<Object>) previousListData).getListListeners().remove(
						listDataListener);
			}
	 ...
	 * 
	 * @param listData
	 *            The list data to be presented by the list button as a JSON
	 *            array.
	 */
	...
	public void setListData(URL listData) {
		...
		try {
			setListData((List<?>) jsonSerializer.readObject(listData
					.openStream()));
		} catch (SerializationException exception) {
			throw new IllegalArgumentException(exception);
	 ...
	 * <p>
	 * Use {@link #setDataRenderer(org.apache.pivot.wtk.Button.DataRenderer)} to
	...
	private boolean fireOnAll = false;

	public void setFireListenersOnAllSelections(boolean b) {
		this.fireOnAll = b;
	}
	 ...
	 * 
	 * @param selectedIndex
	 *            The index of the list item to select, or <tt>-1</tt> to clear
	 *            the selection.
	 */
	public void setSelectedIndex(int selectedIndex) {
		indexBoundsCheck("selectedIndex", selectedIndex, -1,
				listData.getLength() - 1);
	...
	public void setSelectedItem(Object item) {
		setSelectedIndex((item == null) ? -1 : ((List<Object>) listData)
				.indexOf(item));
	}
	 ...
	 *            The disabled item filter, or <tt>null</tt> for no disabled
	 *            item filter.
	 */
	public void setDisabledItemFilter(Filter<?> disabledItemFilter) {
		...
		if (previousDisabledItemFilter != disabledItemFilter) {
			...
			listButtonListeners.disabledItemFilterChanged(this,
					previousDisabledItemFilter);
		}
	}
	...
	public void setListDataKey(String listDataKey) {
		...
		if (previousListDataKey != listDataKey) {
			...
			listButtonBindingListeners.listDataKeyChanged(this,
					previousListDataKey);
		}
	}
	...
	public void setListDataBindType(BindType listDataBindType) {
		...
		if (previousListDataBindType != listDataBindType) {
			...
			listButtonBindingListeners.listDataBindTypeChanged(this,
					previousListDataBindType);
		}
	}
	...
	public void setListDataBindMapping(ListDataBindMapping listDataBindMapping) {
		...
		if (previousListDataBindMapping != listDataBindMapping) {
			...
			listButtonBindingListeners.listDataBindMappingChanged(this,
					previousListDataBindMapping);
		}
	}
	...
	public void setSelectedItemKey(String selectedItemKey) {
		...
		if (previousSelectedItemKey != selectedItemKey) {
			...
			listButtonBindingListeners.selectedItemKeyChanged(this,
					previousSelectedItemKey);
		}
	}
	...
	public void setSelectedItemBindMapping(
